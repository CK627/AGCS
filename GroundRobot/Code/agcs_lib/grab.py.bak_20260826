...
class Grabber:
    ...
    def __init__(self, board, ik, ak, params, K, R, T, detect, display=None):
        self.board = board
        self.ik = ik
        self.ak = ak
        self.params = params
    ...
    def run(self, cy=None, x_dis=None, y_dis=None):
        ...
        for attempt in range(self.attempts):
            ...
            print('[grab] 像素=%s -> x=%.1f cm y=%.1f cm' % (center, x, y))
