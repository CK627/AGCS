...
if __name__ == '__main__':
    ...
    print('2. 六足前进（50mm x 12，速度10）', flush=True)
    ik.go_forward(ik.initial_pos, 2, 50, 10, 12)
    time.sleep(1)
    ...
    print('7. 六足前进（50mm x 16，速度10）', flush=True)
    ik.go_forward(ik.initial_pos, 2, 50, 10, 16)
    time.sleep(1)
