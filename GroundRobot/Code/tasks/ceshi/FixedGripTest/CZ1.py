...
if __name__ == '__main__':
    ...
    print('2. 六足前进 20cm（50mm x 4）', flush=True)
    ik.go_forward(ik.initial_pos, 2, 50, 30, 4)
    time.sleep(1)
    ...
    print('4. 六足后退 20cm（50mm x 4），25 保持夹紧', flush=True)
    ik.back(ik.initial_pos, 2, 50, 30, 4)
    time.sleep(1)
    ...
    ik.turn_left(ik.initial_pos, 2, 30, 40, 3)
    time.sleep(1)

    print('7. 六足前进 40cm（50mm x 8）', flush=True)
    ik.go_forward(ik.initial_pos, 2, 50, 30, 8)
    time.sleep(1)
